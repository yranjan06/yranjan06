...
1. **[The Unsexy Secret (blog) ---](https://yranjan06.github.io/blog#unsexy-secret-building-llm-apps)** 
   - Exploring the fundamentals of building production-ready LLM applications that actually work in the real world.
2. **[Azure Virtual Machine (blog) ---](https://yranjan06.github.io/blog#azure-virtual-machine)**
